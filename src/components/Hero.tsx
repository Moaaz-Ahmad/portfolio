...
import { Github, Linkedin, Mail, ArrowDown, Code, Smartphone, Database } from 'lucide-react'
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className={`max-w-4xl mx-auto transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-7xl font-bold mb-6">
            ...
            <br />
            <span className="text-gray-900 dark:text-white">& Web + Backend</span>
            <br />
          ...
          <p className="text-xl sm:text-2xl text-gray-600 dark:text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed">
            I build end-to-end applications—frontend UI, backend APIs, and data/auth layers—using{' '}
            <span className="text-primary-600 dark:text-primary-400 font-semibold">Next.js</span>,{' '}
            <span className="text-primary-600 dark:text-primary-400 font-semibold">Node.js</span>, and{' '}
            <span className="text-primary-600 dark:text-primary-400 font-semibold">modern databases</span>.
          </p>
          ...
          <div className="flex justify-center items-center space-x-8 mb-12">
            ...
            <div className="flex items-center space-x-2 text-gray-600 dark:text-gray-400">
              ...
              <span className="text-sm font-medium">Mobile (Bonus)</span>
            </div>
            <div className="flex items-center space-x-2 text-gray-600 dark:text-gray-400">
              <Database className="h-6 w-6" />
              <span className="text-sm font-medium">Backend & Data</span>
            </div>
          </div>
