        ...
        <div className={`max-w-7xl mx-auto transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              A comprehensive overview of my technical expertise across frontend UI, backend services,
              data layers, and cross-platform development
            </p>
          </div>
          ...
          <div className="mt-16 text-center">
            <div className="bg-gradient-to-r from-primary-50 to-primary-100 dark:from-primary-900/20 dark:to-primary-800/20 rounded-2xl p-8">
              ...
              <p className="text-gray-600 dark:text-gray-300 max-w-3xl mx-auto leading-relaxed">
                ...
                API design patterns, and development methodologies. My passion for learning drives me to
                build reliable solutions across web and mobile ecosystems.
              </p>
            </div>
          </div>
        </div>
